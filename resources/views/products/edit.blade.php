                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group mt-2">
                            ...
                            <textarea style="height:150px" id="detail" name="detail" placeholder="Detail" class="form-control w-100 @error('detail') is-invalid @enderror">{{ $product->detail }}</textarea>
                            @error('detail')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
