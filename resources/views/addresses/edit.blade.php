...
<div class="d-flex justify-content-center">
    <div class="card shadow bg-white w-100">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route($__env->yieldContent('name') . '.update', $address->id) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <!-- Similar to create form, but with existing data -->
                    ...
                    <div class="mt-2 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="district" id="district" class="form-control @error('district') is-invalid @enderror" value="{{ old('district', $address->district) }}" required>
                            @error('district')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="zip_code" id="zip_code" class="form-control @error('zip_code') is-invalid @enderror" value="{{ old('zip_code', $address->zip_code) }}" required>
                            @error('zip_code')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="detail" id="detail" class="form-control @error('detail') is-invalid @enderror">{{ old('detail', $address->detail) }}</textarea>
                            @error('detail')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
