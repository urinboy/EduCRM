...
<div class="d-flex justify-content-center">
    <div class="card shadow bg-white w-100">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route($__env->yieldContent('name') . '.update', $city->id) }}">
                @csrf
                @method('PUT')
                <div class="row p-2">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group mt-2">
                            ...
                            <input type="text" id="name" name="name" placeholder="City Name" class="form-control w-100 @error('name') is-invalid @enderror" required value="{{ old('name', $city->name) }}">
                            @error('name')
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group mt-2">
                            ...
                            <select id="state_id" name="state_id" class="form-select w-100 @error('state_id') is-invalid @enderror" required>
