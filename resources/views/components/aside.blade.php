...
<aside class="bsb-sidebar-1 offcanvas offcanvas-start" tabindex="-1" id="bsbSidebar1"
    ...
    <div class="offcanvas-header">
        <a class="sidebar-brand fw-bold text-danger d-flex justify-content-center align-items-center"
    ...
    <div class="offcanvas-body pt-0">
        ...
        <ul class="navbar-nav">
            ...
            @else
                ...
                <li class="nav-item mt-3">
                    <h6 class="py-1 text-center fw-bold text-secondary text-uppercase fs-7">{{ __('Menu') }}</h6>
                </li>
                <li class="nav-item">
