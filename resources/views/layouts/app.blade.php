...
<head>
    ...
    <!-- Scripts -->
    @vite(['resources/sass/app.scss', 'resources/css/app.css', 'resources/css/navbar.css', 'resources/css/sidebar.css', 'resources/css/animate.min.css', 'resources/js/alert.js',  'resources/js/app.js'])
</head>
...
<body>
    <div id="app">
        ...
        <footer style="background-color: #f8f9fa; padding: 20px; text-align: center;">
            ...
            <p>
                <a href="{{ route('privacyPolicy') }}" style="margin-right: 15px; text-decoration: none; color: #333;">{{ strtoupper(__("Privacy Policy")) }}</a>
                <a href="{{ route('termsOfServices') }}" style="margin-right: 15px; text-decoration: none; color: #333;">{{ strtoupper(__("Terms of Service")) }}</a>
                <a href="{{ route('contacts.create') }}" style="text-decoration: none; color: #333;">{{ strtoupper(__('Contact Us')) }}</a>
            </p>
        </footer>
    </div>
