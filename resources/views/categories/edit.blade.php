...
@section('content')
    ...
    @endif
    <form method="POST" action="{{ route($__env->yieldContent('name') . '.update', $category->id) }}"
                ...
                <div class="card shadow bg-white border rounded p-2">
                    <div class="card-body">
                        ...
                        <div class="mb-3 text-center">
                            ...
                            @if ($category->image)
                                <img id="image-preview"  src="{{ Storage::url($category->image) }}" alt="{{ $category->name }}"
                                    style="margin: 10px auto; width:100%; margin-top:10px;">
